        ...
        try {
          ...
          while (elapsedSeconds < timeoutSeconds) {
            ...
            if (testId) {
              ...
              if (!taskInfo) {
                throw Error(
                  'Malformed workflow status response: task info missing'
                )
              }
            }
            ...
            if (testId) {
              ...
              if (
                taskInfo.current_step_index !== undefined &&
                taskInfo.total_steps
              ) {
              ...
              if (taskInfo.current_test) {
                const testName =
                  taskInfo.current_test.test_name ||
                  taskInfo.current_test.test_id
              ...
              if (
                taskInfo.completed_tests !== undefined &&
                taskInfo.total_tests
              ) {
            ...
            if (['completed', 'failed', 'cancelled'].includes(currentStatus)) {
              ...
              if (workflowId) {
                ...
                if (
                  taskInfo.test_results &&
                  Array.isArray(taskInfo.test_results)
                ) {
